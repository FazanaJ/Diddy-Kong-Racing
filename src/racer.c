...
void func_80042D20(Object *obj, Object_Racer *racer, s32 updateRate) {
    ...
    if (race_finish_timer() != 0) {
        ...
        if (var_t0 != 0) {
            ...
            if (7 - var_t5 == 7 && sp58 != NULL && sp90 < -2500.0f) {
                racer->unk1CA = 1;
                racer->unk209 = (u16) (racer->unk209 & 0xFFFB);
            }
            if (gRaceStartTimer == 0) {
            ...
            switch (racer->unk1C9) {
                case 0:
                    if (sp5C != NULL && sp5C->racer.playerIndex == PLAYER_COMPUTER && sp5C->racer.unk1C9 == 0) {
                        if (racer->unk1CA == sp5C->racer.unk1CA && sp94 < 100.0f) {
                            racer->unk1CA++;
                            if (racer->unk1CA > 3) {
                                racer->unk1CA = 3;
                            }
...
void racer_AI_pathing_inputs(Object *obj, Object_Racer *racer, s32 updateRate) {
    ...
    if (racer->velocity > -1.0f && racer->unk214 == 0 && !gRaceStartTimer && D_8011D544 == 0.0f &&
...
void func_80046524(s32 updateRate, f32 updateRateF, Object *obj, Object_Racer *racer) {
    ...
    spC8 = 1.0f - (gDialogueCameraAngle / 10240.0f);
    ...
    if (gCurrentRacerInput & A_BUTTON) {
        racer->throttle += updateRateF * 0.016f;
        if (racer->throttle > 1.0f) {
            racer->throttle = 1.0f;
        }
    } else {
        racer->throttle -= updateRateF * 0.016f;
    ...
    if (racer->zipperDirCorrection != 0) {
        ...
        if ((var_v1 < 0x400 && var_v1 > -0x400) || (racer->playerIndex == PLAYER_COMPUTER)) {
            ...
            obj->segment.x_velocity = (obj->segment.x_velocity * 1.0f) * 0.75f;
            obj->segment.y_velocity = (obj->segment.y_velocity * 1.0f) * 0.75f;
            obj->segment.z_velocity = (obj->segment.z_velocity * 1.0f) * 0.75f;
        }
    }
    ...
    xVelTemp = (gCurrentRacerMiscAssetPtr[var_v0 + 1] * var_f0) + (gCurrentRacerMiscAssetPtr[var_v0] * (1.0f - var_f0));
    gCurrentRacerWeightStat *= 0.75f;
    if (racer->groundedWheels >= 3) {
        obj->segment.y_velocity -= gCurrentRacerWeightStat * 0.5f * updateRateF;
    } else {
    ...
    if (gCurrentRacerInput & B_BUTTON && gCurrentStickY >= -40 && racer->velocity >= -0.5f) {
        spFC *= 16.0f;
    }
    velocity = (iTemp * 8) * updateRate;
    if (gCurrentStickY < 0) {
        temp = -gCurrentStickY;
        velocity *= 1.0f + (temp / 112.0f);
        xVelTemp *= 1.0f - (temp / 300.0f);
    }
    velocity *= gCurrentRacerHandlingStat;
    racer->steerVisualRotation -= (((s32) velocity) & 0xffff) & 0xffff;
    if (racer->groundedWheels == 0 && racer->buoyancy == 0.0f) {
    ...
    if (racer->groundedWheels || racer->buoyancy > 0.0f) {
        if (racer->trickType != 0) {
            ...
            if (var_f2 > 0.0f && racer->approachTarget == NULL) {
                racer->stretch_height_cap = 1.0f - (var_f2 * 0.02f);
            }
            racer->trickType = 0;
        }
    }
    xVelTemp *= handle_racer_top_speed(obj, racer) * 1.7f;
    if (racer->boostTimer > 0) {
        if (gRaceStartTimer == 0) {
            spF4 = 1.0f;
            spF0 = 0.0f;
    ...
    if (racer->zipperDirCorrection == 0) {
        if (gCurrentPlayerIndex == PLAYER_COMPUTER && !racer->raceFinished) {
            ...
            temp = racer->lateral_velocity * 0.07f;
            if (gCurrentRacerInput & R_TRIG) {
                temp *= 2.0f;
                if (gCurrentStickX > -40 && gCurrentStickX < 40) {
                    spF4 *= 0.8f;
                } else if ((racer->lateral_velocity > 2.5f) || (racer->lateral_velocity < (-2.5f))) {
                    spF4 *= 1.5f;
                }
        ...
        if (racer->groundedWheels && !gRacerInputBlocked && gRaceStartTimer == 0) {
            var_f2 = (gCurrentRacerWeightStat * updateRateF) * 0.25f;
    ...
    if (racer->approachTarget == NULL) {
        ...
        if (gRacerInputBlocked) {
            ...
            if (zVelTemp > 0.5f || zVelTemp < -0.5f) {
                zVelTemp *= 0.65f;
            } else {
                zVelTemp = 0.0f;
            }
    ...
    racer->unkD0 -= (racer->unkD0 * 0.125f) * updateRateF;
    racer->unkD4 = (-obj->segment.y_velocity) * 7.0f;
    if (racer->unkD4 > 35.0f) {
        racer->unkD4 = 35.0f;
    }
    if (racer->unkD4 < 0.0f) {
        racer->unkD4 = 0.0f;
    ...
    if (racer->buoyancy > 0.0f) {
        ...
        racer->unkC4 += (0.75f - racer->unkC4) * 0.125f;
    }
    ...
    if (gCurrentPlayerIndex != PLAYER_COMPUTER && racer->boostTimer == 0 && (gNumViewports < 2 || gConfig.noCutbacks)) {
        ...
        if (iTemp > 10) {
            if (asset20->unk70 > 0 || asset20->unk74 > 0.0f) {
                obj->particleEmitFlags |= 1 << iTemp;
            }
        } else if (asset20->unk70 == 2 && asset20->unk74 < 0.5f) {
            obj->particleEmitFlags |= 1 << iTemp;
    ...
    if (gCurrentButtonsPressed & R_TRIG && (racer->buoyancy > 0.0f || racer->groundedWheels >= 2) &&
        racer->unk1FB == 0) {
        if (racer->buoyancy != 0.0f) {
            obj->segment.y_velocity += 4.5f;
            if (obj->segment.y_velocity > 5.5f) {
                obj->segment.y_velocity = 5.5f;
            }
        } else {
            obj->segment.y_velocity += 3.5f;
        }
        var_f2 = ((2.0f * obj->segment.y_velocity) / gCurrentRacerWeightStat);
...
void update_camera_hovercraft(f32 updateRate, Object *obj, Object_Racer *racer) {
    ...
    gCameraObject->unk1C += ((phi_f14 - gCameraObject->unk1C) * 0.0625f) * updateRate;
    gCameraObject->unk20 += ((phi_f18 - gCameraObject->unk20) * 0.0625f) * updateRate;
    ...
    xVel = sins_f(-racer->cameraYaw + 0x8000 + addAngle) * gCameraObject->unk1C;
    zVel = coss_f(-racer->cameraYaw + 0x8000 + addAngle) * gCameraObject->unk1C;
    ...
    gCameraObject->trans.rotation.y_rotation = racer->cameraYaw + addAngle;
    ...
    if (tempRacer->playerIndex == PLAYER_COMPUTER) {
        ...
        if (gRaceStartTimer == 0 && tempRacer->playerIndex == PLAYER_ONE) {
            if (get_filtered_cheats() & CHEAT_PRINT_COORDS) {
                render_printf(gRacerDebugCoords, (f64) obj->segment.trans.x_position,
                              (f64) obj->segment.trans.y_position, (f64) obj->segment.trans.z_position);
            }
        }
        ...
        if (tempRacer->unk1FE == 2) {
            tempRacer->unk84 += ((sins_f((tempRacer->unk1FF << 8)) * 4.0f) - tempRacer->unk84) * 0.0625f * updateRateF;
            tempRacer->unk88 += ((coss_f((tempRacer->unk1FF << 8)) * 4.0f) - tempRacer->unk88) * 0.0625f * updateRateF;
        } else {
        ...
        if (obj->segment.y_velocity < 4.0f && (tempRacer->groundedWheels > 2 || tempRacer->buoyancy != 0.0f)) {
            tempRacer->unk1F1 = 0;
        }
        ...
        if (gRaceStartTimer == 0 && header->laps > (tempRacer->countLap)) {
            ...
            if (tempRacer->lap_times[tempRacer->countLap] < (36000) - updateRate) {
                tempRacer->lap_times[tempRacer->countLap] += updateRate;
            } else {
                tempRacer->lap_times[tempRacer->countLap] = (36000);
            }
        }
        ...
        if (tempVar == 0) {
            ...
            if (tempRacer->checkpoint >= checkpointCount) {
                ...
                if (tempRacer->playerIndex != PLAYER_COMPUTER && tempRacer->lap + 1 == header->laps && !D_8011D580 &&
                    gCurrentLevelHeader->race_type == RACETYPE_DEFAULT) {
                ...
                if (gCurrentPlayerIndex != PLAYER_COMPUTER) {
                    ...
                    if (tempRacer->challengeMarker) {
                        ...
                        if (tempRacer->vehicleID == VEHICLE_CAR) {
                            tempRacer->challengeMarker->segment.trans.y_position -= 30.0f;
                        }
        ...
        tempRacer->stretch_height +=
            (((tempRacer->stretch_height_cap - tempRacer->stretch_height) * 0.125f) + stretch) * updateRateF;
        ...
        if (tempRacer->unk150 && gRaceStartTimer == 0) {
            ...
            if (obj->segment.object.distanceToCamera < 1500.0f || get_filtered_cheats() & CHEAT_MIRRORED_TRACKS) {
...
void func_8004F7F4(s32 updateRate, f32 updateRateF, Object *racerObj, Object_Racer *racer) {
    ...
    if (gCurrentPlayerIndex == PLAYER_COMPUTER || racer->raceFinished) {
        ...
        if (racer->buoyancy != 0.0f && racer->vehicleIDPrev != VEHICLE_BUBBLER) {
            spB8 = racer->buoyancy - 10.0f;
            racerObj->segment.y_velocity += spB8 * 0.065f * updateRateF;
        }
        currentLevelHeader = get_current_level_header();
        if ((racer->buoyancy != 0.0f && currentLevelHeader->unk2 != 0) || gCurrentSurfaceType == SURFACE_FROZEN_WATER) {
            if (racer->unk1F0 != 0) {
        ...
        if (D_8011D550) {
            ...
            racer->stretch_height_cap = (1.0f - ((f32) (D_8011D552 - 40) * 0.004f));
            racer->trickType = 0;
        }
        if (racer->unk1F0 == 0) {
        ...
        if (racer->approachTarget == NULL) {
            ...
            if (gRacerInputBlocked != 0) {
                spB8 *= 0.65f;
                spB4 *= 0.65f;
                if (racer->velocity < -0.5f || racer->velocity > 0.5f) {
                    racer->velocity *= 0.65f;
                } else {
                    racer->velocity = 0.0f;
                }
                if (racer->lateral_velocity < -0.5f || racer->lateral_velocity > 0.5f) {
                    racer->lateral_velocity *= 0.65f;
                } else {
                    racer->lateral_velocity = 0.0f;
                }
            } else {
        ...
        if (racer->unk1D2 != 0) {
            ...
            if (spBC > 0.5f) {
                racer->lateral_velocity -= spBC - 0.5f;
            }
            if (spBC < -0.5f) {
                racer->lateral_velocity -= spBC + 0.5f;
            }
        ...
        if (racer->boostTimer == 0 && gNumViewports < 2) {
            ...
            if (var_v1 > 0x10) {
                ...
                if (asset20->unk70 == 2 && asset20->unk74 < 0.5f) {
                    racerObj->particleEmitFlags |= 1 << var_v1;
                } else if (asset20->unk70 < 2 && asset20->unk74 > 0.0f) {
                    racerObj->particleEmitFlags |= 1 << var_v1;
                }
        ...
        if (gCurrentPlayerIndex != PLAYER_COMPUTER && gNumViewports < 2) {
            if (racer->buoyancy > 14.0f) {
                ...
                if (racer->velocity > -3.0f && racer->velocity < 0.5f && get_random_number_from_range(0, 1) != 0) {
        ...
        if (gNumViewports == 1 && racer->velocity > -3.0f && get_settings()->courseId != ASSET_LEVEL_WIZPIG1) {
...
void func_80050A28(Object *obj, Object_Racer *racer, s32 updateRate, f32 updateRateF) {
    ...
    if (gDialogueCameraAngle == 0) {
        tempVel = (f32) D_800DCDB0[0][(racer->miscAnimCounter / 2) & 0x1F] * 0.025f;
    ...
    if (racer->drifting == 0 && racer->velocity > 2.0f && gCurrentRacerInput & R_TRIG &&
    ...
    if (racer->drift_direction == 0 && gCurrentRacerInput & R_TRIG && racer->velocity < -3.0f &&
    ...
    if (racer->velocity > -3.0f) {
        tempVel = -(racer->velocity + 2.0f);
        if (tempVel < 0.0f) {
            tempVel = 0.0f;
        }
    ...
    if (gNumberOfViewports < THREE_PLAYERS) {
        if ((sp60 != 0 && racer->velocity < -2.0f) || sp58 != 0 || racer->unk1FB != 0) {
    ...
    if (racer->unk18 == NULL && surfaceType != SOUND_NONE && racer->velocity < -2.0f) {
    ...
    if (racer->velocity < -2.0f && sp68 >= 4) {
        tempVel = (f32) (racer->miscAnimCounter & 2) * 0.25f;
        racer->carBobX -= racer->roll * tempVel;
        racer->carBobY -= racer->yaw * tempVel;
        racer->carBobZ -= racer->pitch * tempVel;
    }
    ...
    traction = ((gCurrentRacerMiscAssetPtr[temp + 1] * (traction - temp)) +
                (gCurrentRacerMiscAssetPtr[temp] * (1.0f - (traction - temp))));
    traction *= 1.7f;
    traction *= topSpeed;
        ...
        if (gRaceStartTimer == 0) {
            ...
            if (traction != 0.0f) {
                if (is_in_adventure_two()) {
                    traction = ADVENTURE_TWO_BOOST_SPEED;
                } else {
                    traction = 2.0f;
                }
            }
    ...
    if (racer->velocity > -2.0f && racer->velocity < 3.0f &&
        ...
        if ((gCurrentStickY < -25) && !(gCurrentRacerInput & A_BUTTON) && (gCurrentRacerInput & B_BUTTON)) {
            ...
            racer->velocity += tempVel * (updateRateF / 2.0f);
            ;
            racer->brake = 0.0f;
        }
    }
    tempVel = (racer->brake * traction) * 0.32f;
    racer->velocity -= (traction * racer->throttle) * (updateRateF / 2.0f);
    ...
    if (racer->brake < 0.9f && racer->vehicleIDPrev < VEHICLE_TRICKY && gRaceStartTimer == 0) {
...
void handle_racer_head_turning(Object *obj, Object_Racer *racer, UNUSED s32 updateRate) {
    ...
    if (foundObj == FALSE) {
        if ((racer->miscAnimCounter & 0x3F) < 2) {
...
s32 turn_head_towards_object(Object *obj, Object_Racer *racer, Object *targetObj, f32 distance) {
    ...
    if ((diffX * diffX) + (diffZ * diffZ) < distance) {
        ...
        if ((racer->miscAnimCounter & 0x7F) < 0x3F) {
            racer->headAngleTarget = 0;
        }
...
void racer_spinout_car(Object *obj, Object_Racer *racer, s32 updateRate, f32 updateRateF) {
    ...
    racer->velocity -= (racer->velocity * 0.03f) * updateRateF;
    racer->lateral_velocity = 0.0f;
    if (racer->raceFinished == FALSE) {
        rumble_set(racer->playerIndex, RUMBLE_TYPE_0);
    }
...
void update_car_velocity_offground(Object *obj, Object_Racer *racer, s32 updateRate, f32 updateRateF) {
    ...
    angle = angle > 0x8000 ? angle - 0xFFFF : angle;
    angle = angle < -0x8000 ? angle + 0xFFFF : angle;
    obj->segment.trans.rotation.x_rotation += (angle >> 3) * updateRate;
...
void func_80053750(Object *objRacer, Object_Racer *racer, f32 updateRateF) {
    ...
    if (temp_v1 >= 4) {
        ...
        if (racer->brake > 0.4f) {
            if (racer->throttle < 0.4f) {
                velocity = 0.0f;
            }
            isNotHardBraking = FALSE;
        }
        racer->unkB0 -= (velocity * updateRateF) * 0.5f;
        while (racer->unkB0 > 5.0f) {
            racer->unkB0 -= 5.0f;
            for (i = 0; i < 4; i++) {
        ...
        for (i = 0; i < 4; i++) {
            ...
            if (!(racer->unk1E3 & flags)) {
                someObj->segment.trans.y_position += ((-10.0f - someObj->segment.trans.y_position) * 0.125f);
                if (racer->waterTimer != 0) {
                    someObj->segment.trans.scale +=
                        (((someObj->segment.header->scale * 1.4f) - someObj->segment.trans.scale) * 0.1f);
                }
            } else {
                temp_f0 = someObj->segment.trans.y_position;
                someObj->segment.trans.y_position = (temp_f0 - (temp_f0 * 0.125f));
                someObj->segment.trans.scale += ((someObj->segment.header->scale - someObj->segment.trans.scale) * 0.1f);
            }
            flags <<= 1;
        }
...
void update_car_velocity_ground(Object *obj, Object_Racer *racer, s32 updateRate, f32 updateRateF) {
    ...
    racer->steerVisualRotation -= temp * updateRate;
    handle_car_steering(racer);
    racer->lateral_velocity -= (racer->lateral_velocity * 0.05f) * updateRateF;
    surfaceType = SURFACE_DEFAULT;
    traction = 0.0f;
    ...
    vel = (gCurrentRacerMiscAssetPtr[velocityS + 1] * temp_f0_2) +
          (gCurrentRacerMiscAssetPtr[velocityS] * (1.0f - temp_f0_2));
    vel *= 1.7f;
    vel *= multiplier;
    if (racer->boostTimer > 0) {
        if (gRaceStartTimer == 0) {
    ...
    racer->velocity -= (vel * racer->throttle) * (updateRateF / 2.0f);
    if (racer->velocity > -0.04f && racer->velocity < 0.04f) {
        racer->velocity = 0.0f;
    }
    if (racer->velocity < 0.0f) {
        racer->velocity += forwardVel * (updateRateF / 2.0f);
        if (racer->velocity > 0.0f) {
            racer->velocity = 0.0f;
        }
    } else {
...
void func_80054FD0(Object *racerObj, Object_Racer *racer, s32 updateRate) {
    ...
    if (flags) {
        ...
        sp178 *= 0.25f;
        if (sp178 < (racerObj->segment.trans.y_position - 4.0f)) {
            sp5C = 1;
        }
    }
    ...
    if (sp184 != 0) {
        ...
        if ((temp_s16 < 0x2000 && temp_s16 > -0x2000) || racer->vehicleID == VEHICLE_HOVERCRAFT) {
            sp178 = racer->velocity * 1.075f;
            if (sp178 < 0) {
                sp178 = -sp178;
            }
            if (sp178 > 1.0f) {
                rumble_set_fade(racer->playerIndex, 18, sp178 * 0.125f);
            }
            if (sp178 > 4.0f) {
                racer->unk1F3 |= 8;
                if (gCurrentPlayerIndex != PLAYER_COMPUTER) {
...
void onscreen_ai_racer_physics(Object *obj, Object_Racer *racer, UNUSED s32 updateRate) {
    ...
    shouldSquish = FALSE;
    if (flags && tempPos.y < obj->segment.trans.y_position - 4.0f) {
        shouldSquish = TRUE;
    }
...
void handle_racer_items(Object *obj, Object_Racer *racer, UNUSED s32 updateRate) {
    ...
    if (racer->held_obj != NULL) {
        ...
        if (gCurrentButtonsPressed & Z_TRIG || racer->raceFinished || racer->attackType) {
            ...
            heldObj->segment.x_velocity = obj->segment.x_velocity * 0.7f;
            heldObj->segment.y_velocity = obj->segment.y_velocity - 2.0f;
            heldObj->segment.z_velocity = obj->segment.z_velocity * 0.7f;
...
void racer_activate_magnet(Object *obj, Object_Racer *racer, s32 updateRate) {
    ...
    if (vel < 8.0f && racer->magnetLevel3 == FALSE) {
        vel = 8.0f;
    }
    if (vel > 20.0f) {
        vel = 20.0f;
            ...
            do {
                if (gCurrentLevelHeader->race_type != RACETYPE_CHALLENGE) {
                    ...
                    if (bananaObj != NULL) {
                        ...
                        bananaObj->segment.y_velocity = (0.0f - racer->oy1) + 5.0f;
...
void update_player_camera(Object *obj, Object_Racer *racer, f32 updateRateF) {
    ...
    gCameraObject->offsetX = (((obj->segment.trans.x_position + (91.75f * racer->ox1) + (90.0f * racer->ox3)) -
                               gCameraObject->trans.x_position) *
                              dialogueAngle);
    gCameraObject->offsetZ = (((obj->segment.trans.z_position + (91.75f * racer->oz1) + (90.0f * racer->oz3)) -
                               gCameraObject->trans.z_position) *
                              dialogueAngle);
...
void func_80059208(Object *obj, Object_Racer *racer, s32 updateRate) {
    ...
    if (splinePos < -0.2f) {
        ...
        if (angle > 0x4000 || angle < -0x4000) {
            if (racer->unk1FC < 200 && racer->velocity <= -1.0f) {
...
void alloc_ghost_pool(void) {
    if (is_time_trial_enabled()) {
        gGhostData[0] = mempool_alloc_safe(
            (sizeof(GhostNode) * 2) * MAX_NUMBER_OF_GHOST_NODES, MEMP_GHOST_DATA);
...
s32 load_tt_ghost(s32 ghostOffset, s32 size, s16 *outTime) {
    GhostHeader *ghost = mempool_alloc_safe(size, MEMP_GHOST_DATA);
    if (ghost != NULL) {
        ...
        gGhostData[GHOST_STAFF] = mempool_alloc_safe(size - sizeof(GhostHeader), MEMP_GHOST_DATA);
        if (gGhostData[GHOST_STAFF] != NULL) {
            *outTime = ghost->time;
 ...
 * Mostly the same as how the player controlled one works, minus controller input and includes some decisionmaking
 * logic.
 */
void update_AI_racer(Object *obj, Object_Racer *racer, s32 updateRate, f32 updateRateF) {
    ...
    racer->miscAnimCounter += updateRate;
    ...
    if (racer->bubbleTrapTimer > 0) {
        ...
        racer->velocity -= (racer->velocity * 0.1f) * updateRateF;
    }
    if (racer->unk206 > 0) {
    ...
    if (racer->unk201 != 0) {
        ...
        if (racer->unk1FE == 2) {
            racer->unk84 += ((((sins_f(racer->unk1FF << 8) * 4) - racer->unk84) * 0.0625f * updateRateF));
            racer->unk88 += ((((coss_f(racer->unk1FF << 8) * 4) - racer->unk88) * 0.0625f * updateRateF));
        } else {
            racer->unk84 -= racer->unk84 * 0.0625f * updateRateF;
            racer->unk88 -= racer->unk88 * 0.0625f * updateRateF;
        }
        gCurrentRacerHandlingStat = 1;
        gCurrentRacerMiscAssetPtr = (f32 *) get_misc_asset(ASSET_MISC_RACERACCELERATION_UNKNOWN0);
        D_8011D568 = (f32 *) get_misc_asset(obj->segment.header->unk5D);
        if ((obj->segment.y_velocity < 4.0f) && ((racer->groundedWheels >= 3) || (racer->buoyancy != 0.0f))) {
            racer->unk1F1 = 0;
        }
        if (racer->magnetTimer != 0) {
        ...
        switch (racer->vehicleID) {
            ...
            case VEHICLE_FLYING_CAR: /* fall through */
            case VEHICLE_CARPET:
                update_carpet(updateRate, updateRateF, obj, racer);
                break;
            case VEHICLE_TRICKY:
                update_tricky(updateRate, updateRateF, obj, racer, &gCurrentRacerInput, &gCurrentButtonsPressed,
                              &gRaceStartTimer);
                break;
            case VEHICLE_BLUEY:
                update_bluey(updateRate, updateRateF, obj, racer, &gCurrentRacerInput, &gCurrentButtonsPressed,
                             &gRaceStartTimer);
                break;
            case VEHICLE_SMOKEY: /* fall through */
            case VEHICLE_PTERODACTYL:
                update_smokey(updateRate, updateRateF, obj, racer, &gCurrentRacerInput, &gCurrentStickX,
                              &gRaceStartTimer);
                break;
            case VEHICLE_BUBBLER:
                update_bubbler(updateRate, updateRateF, obj, racer, &gCurrentRacerInput, &gCurrentButtonsPressed,
                               &gRaceStartTimer);
                break;
            case VEHICLE_WIZPIG:
                update_wizpig(updateRate, updateRateF, obj, racer, &gCurrentRacerInput, &gCurrentButtonsPressed,
                              &gRaceStartTimer);
                break;
            case VEHICLE_ROCKET:
                update_rocket(updateRate, updateRateF, obj, racer, &gCurrentRacerInput, &gCurrentButtonsPressed,
                              &gRaceStartTimer);
                break;
        }
        ...
        if (checkpoint->unk36[racer->unk1CA] == 4) {
            if (racer->velocity < -4.0f) {
                racer->velocity -= (racer->velocity * 0.05f) * updateRateF;
            }
        }
        if (var_t2 == 0) {
    ...
    racer->stretch_height =
        (racer->stretch_height +
         ((((racer->stretch_height_cap - racer->stretch_height) * 0.125f) + temp_fv1_2) * updateRateF));
    ...
    if ((racer->unk150 != NULL) && (gRaceStartTimer == 0)) {
        ...
        if (obj->segment.object.distanceToCamera < 1500.0f) {
...
void func_8005B818(Object *obj, Object_Racer *racer, s32 updateRate, f32 updateRateF) {
    ...
    if (racer->vehicleID == VEHICLE_HOVERCRAFT) {
        ...
        if (racer->velocity < -var_f12) {
            ...
            racer->velocity += ((-var_f12 - racer->velocity) * 0.125f);
        }
    } else {
    ...
    j = 0;
    do {
        checkpointDistance = (1.0f - racer->checkpoint_distance) + (racer->unkAC * updateRateF);
        if (checkpointDistance >= 1.0f) {
            checkpointSplineIdx = 1;
            checkpointDistance -= 1.0f;
        }
    ...
    if (checkpointPositionOffset > 35.0f) {
        temp_f0 = (35.0f / checkpointPositionOffset);
        var_f24 *= temp_f0;
        var_f28 *= temp_f0;
    }
    racer->checkpoint_distance = (1.0f - checkpointDistance);
    ...
    if (checkpointPositionOffset < 20.0f) {
