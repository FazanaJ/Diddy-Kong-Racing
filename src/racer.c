...
void racer_AI_pathing_inputs(Object *obj, Object_Racer *racer, s32 updateRate) {
    ...
    if (racer->velocity > -1.0f && racer->unk214 == 0 && !gRaceStartTimer && D_8011D544 == 0.0f && racer->groundedWheels && racer->unk215 == 0) {
...
void func_80046524(s32 updateRate, f32 updateRateF, Object *obj, Object_Racer *racer) {
    ...
    if ((gCurrentRacerInput & 0x4000) && (gCurrentStickY >= (-40)) && (racer->velocity >= (-0.5f))) {
        spFC *= 16.0f;
    }
    ...
    if ((((racer->playerIndex == PLAYER_ONE) && (racer->groundedWheels)) && (var_t1 == 12)) && (gCurrentButtonsPressed & 0x2000)) {
        D_8011D582 = 2;
    }
    ...
    if (temp_f0 > 0.25f) {
        ...
        sp11C *= 0.125;
        racer->unk196 += (((s32) ((var_v1 * ((f32) sp11C)) * 0.75f)) * updateRate) >> 4;
        ...
        var_v1 = var_v1 * ((f32) (temp_f0 / 10.0f));
    ...
    if (racer->zipperDirCorrection == 0) {
        ...
        var_f16 = racer->lateral_velocity * 0.25f;
        ...
        if (gCurrentRacerInput & 0x0010) {
            ...
            if ((racer->lateral_velocity > 2.5f) || (racer->lateral_velocity < (-2.5f))) {
            spF4 *= 1.5f;
            }
        ...
        if (((racer->groundedWheels) && (gRacerInputBlocked == 0)) && (gRaceStartTimer == 0)) {
    ...
    if (((gCurrentButtonsPressed & 0x0010) && ((racer->buoyancy > 0.0f) || (racer->groundedWheels >= 2))) && (racer->unk1FB == 0)) {
        if (racer->buoyancy != 0.0f) {
...
void update_player_racer(Object *obj, s32 updateRate) {
    ...
    if (tempRacer->playerIndex == PLAYER_COMPUTER) {
        ...
        tempRacer->stretch_height += (((tempRacer->stretch_height_cap - tempRacer->stretch_height) * 0.125f) + stretch) * updateRateF;
