...
unk80119C38 *func_80004B40(s8 characterId, s8 vehicleId) {
    ...
    memset = temp_v0_3;
    for (var_a3 = 0; var_a3 < sizeof(unk80119C38); var_a3++) {
        memset[var_a3] = 0;
    }
...
void func_80005D08(Object *arg0, UNUSED u32 buttonsPressed, u32 buttonsHeld, s32 updateRate) {
    ...
    if (check_if_showing_cutscene_camera() == 0 && func_8001139C() == 0) {
        var_f18 = ((D_80119C38->unkBC * var_f2 * var_f16) / 15.0f);
    } else {
        var_f18 = 0.0f;
    }
    ...
    if (var_f16 != 0.0f && D_80119C3C->bananas != 0) {
        if (D_80119C3C->bananas <= 10) {
            var_a1 = D_80119C3C->bananas;
        } else {
            var_a1 = 10;
        }
        if (D_80119C38->unk3C < (0.05f * var_a1)) {
            D_80119C38->unk3C += ((0.05f * var_a1) / (var_a1 * 64));
        } else if (D_80119C38->unk3C > (0.05f * var_a1)) {
            D_80119C38->unk3C = (0.05f * var_a1);
        }
        var_f14 += D_80119C38->unk3C;
    } else {
        D_80119C38->unk3C *= 0.95f;
        var_f14 += D_80119C38->unk3C;
    }
    ...
    if (D_80119C38->unk5C[0] > (0x7FFF / 5000.0f)) {
        D_80119C38->unk5C[0] = (0x7FFF / 5000.0f); //6.5534
    }
...
void func_80006BFC(Object *obj, ObjectSegment *segment, Object *obj2, s32 updateRate) {
    ...
    if (D_80119C38 != NULL) {
        ...
        new_var = func_80007FA4(D_80119C38->unk5C[0]) * 1731.23404f;
        ...
        if (D_80119C38->unk68 > 0.8f) {
            D_80119C38->unk68 = 0.8f;
        } else if (D_80119C38->unk68 < -0.8f) {
            D_80119C38->unk68 = -0.8f;
        }
