...
void init_hud(UNUSED s32 viewportCount) {
    ...
    gAssetHudElements = mempool_alloc_safe(gAssetHudElementIdsCount * (sizeof(void *) + 1), MEMP_HUD);
    ...
    gPlayerHud[PLAYER_ONE] = mempool_alloc_safe(playerCount * sizeof(HudData), MEMP_HUD);
