...
void func_800B0010(Particle *arg0, Particle *arg1, Particle *arg2, ParticleBehavior *arg3) {
    ...
    if (flags) {
        if (flags & 0x100) {
            arg0->segment.x_velocity += (f32) get_random_number_from_range(-arg3->velocityRangeX1, arg3->velocityRangeX1) * 0.00001525878906f;
        }
        if (flags & 0x200) {
            arg0->segment.y_velocity += (f32) get_random_number_from_range(-arg3->velocityRangeY1, arg3->velocityRangeY1) * 0.00001525878906f;
        }
        if (flags & 0x400) {
            arg0->segment.z_velocity += (f32) get_random_number_from_range(-arg3->velocityRangeZ1, arg3->velocityRangeZ1) * 0.00001525878906f;
        }
    }
    ...
    if (arg3->flags & 4) {
        ...
        flags = arg3->unk5C;
        if (flags & 0x10) {
            velocityPos.z += (f32) get_random_number_from_range(-arg3->gravityRange2, arg3->gravityRange2) * 0.00001525878906f;
        }
        if (flags & (0x40 | 0x20)) {
...
void func_800B03C0(Particle *arg0, Particle *arg1, Particle *arg2, ParticleBehavior *behaviour) {
    ...
    if (behaviour->unk5C & 0x80000) {
        arg0->forwardVel += (f32) get_random_number_from_range(-behaviour->velocityRange, behaviour->velocityRange) * 0.00001525878906f; // 0.00001525878906 ~= 1.0/65536.0
    }
    if (behaviour->flags & 1) {
        ...
        if (flags & 1) {
            posVel.z += (f32) get_random_number_from_range(-behaviour->gravityRange1, behaviour->gravityRange1) * 0.00001525878906f;
        }
        if (flags & (4 | 2)) {
...
void func_800B22FC(Particle *arg0, s32 arg1) {
    ...
    if (arg0->segment.particle.unk2C == 3) {
        ...
        if (sp20 == NULL || (sp20 != NULL && sp20->unk70 != 0)) {
            if (arg0->segment.particle.unk39 == 2) {
                func_800B3358(arg0);
            } else if (arg0->segment.particle.unk39 == 3) {
                func_800B3240(arg0);
            } else if (arg0->segment.particle.unk39 == 4) {
                func_800B3140(arg0);
            } else if (arg0->segment.particle.unk39 == 5) {
                func_800B3564(arg0);
            } else {
                func_800B34B0(arg0);
            }
        }
        temp_v0_2 = get_segment_bounding_box(arg0->segment.particle.unk2E);
        if (temp_v0_2 != NULL) {
            if (arg0->segment.trans.x_position < temp_v0_2->x1 || temp_v0_2->x2 < arg0->segment.trans.x_position || 
                ...
                arg0->segment.particle.unk2E = get_level_segment_index_from_position(arg0->segment.trans.x_position, arg0->segment.trans.y_position, arg0->segment.trans.z_position);
            }
        } else {
            arg0->segment.particle.unk2E = get_level_segment_index_from_position(arg0->segment.trans.x_position, arg0->segment.trans.y_position, arg0->segment.trans.z_position);
        }
        arg0->segment.particle.unk3A -= D_80127C80;
        if (arg0->segment.particle.unk3A <= 0) {
            gParticlePtrList_addObject((Object*) arg0);
        } else {
            if (arg0->unk60 == 0) {
                arg0->unk5C += D_80127C80 * arg0->unk5E;
                if (arg0->unk5C < 0xFF) {
                ...
                arg0->unk60 -= D_80127C80;
                if (arg0->unk60 < 0) {
                    arg0->unk5C -= (arg0->unk60 * arg0->unk5E);
                    arg0->unk60 = 0;
                }
            }
        }
