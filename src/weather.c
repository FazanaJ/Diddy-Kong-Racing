...
unk800E2C2C gRainGfx[2] = { { 0, 0, 0x400, 0x400, 0x000A, 0xFFC4, NULL, 128, 255, 255, 128, 128, 255, 128, 0 },
...
void process_weather(Gfx **currDisplayList, MatrixS **currHudMat, Vertex **currHudVerts, TriangleList **currHudTris,
    ...
    if (gWeatherType != WEATHER_SNOW) {
        ...
        D_80127BB4 = (D_80127BB0 * D_80127BB8.unk0) >> (16);
        D_80127BF8.unk4 = (D_80127BF8.unk0 + ((D_80127BF8.unk2 - D_80127BF8.unk0) * D_80127BB8.unk30)) >> (16);
