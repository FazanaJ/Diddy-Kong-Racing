...
s32 func_800099EC(u8 arg0) {
    ...
    for (i = 0; i < temp_v0->unk17C; i++) {
        temp_f0 = *var_a2;
        if (temp_f0 == -100000.0f || temp_f0 + 1 == -100000.0f || temp_f0 + 2 == -100000.0f) {
            ret = 0;
        }
        var_a2 += 3;
    }
...
s32 func_80009AB4(u8 arg0) {
    ...
    for (i = 0; i < levelHeader->unkB8; i++, var_a2++) {
        if ((var_a2->unk0 == -100000.0f) || (var_a2->unk0 + 1 == -100000.0f) || (var_a2->unk0 + 2 == -100000.0f)) {
            ret = 0;
        }
    }
