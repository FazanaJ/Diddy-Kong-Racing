...
void wave_init(void) {
    ...
    free_waves();
    D_800E3040 = (f32 *) mempool_alloc_safe(D_80129FC8.unk20 << 2, MEMP_WAVES);
    D_800E3044 = (s16 *) mempool_alloc_safe((D_80129FC8.unk4 << 2) * D_80129FC8.unk4, MEMP_WAVES);
    D_800E3048 = (s32 *) mempool_alloc_safe(((D_80129FC8.unk0 + 1) << 2) * (D_80129FC8.unk0 + 1), MEMP_WAVES);
    allocSize = ((D_80129FC8.unk0 + 1) << 2) * (D_80129FC8.unk0 + 1);
    D_800E304C[0] = mempool_alloc_safe(allocSize * ARRAY_COUNT(D_800E304C), MEMP_WAVES);
    ...
    if (D_8012A078 != 2) {
        D_800E3070[0] = (Vertex *) mempool_alloc_safe(allocSize << 1, MEMP_WAVES);
        D_800E3070[1] = (Vertex *) (((u32) D_800E3070[0]) + allocSize);
    } else {
        D_800E3070[0] = (Vertex *) mempool_alloc_safe(allocSize << 2, MEMP_WAVES);
        D_800E3070[1] = (Vertex *) (((u32) D_800E3070[0]) + allocSize);
    ...
    if (D_8012A078 != 2) {
        D_800E3080[0] = mempool_alloc_safe(allocSize << 1, MEMP_WAVES);
        D_800E3080[1] = (u8 *) (((u32) D_800E3080[0]) + allocSize);
    } else {
        D_800E3080[0] = (u8 *) mempool_alloc_safe(allocSize << 2, MEMP_WAVES);
        D_800E3080[1] = (u8 *) (((u32) D_800E3080[0]) + allocSize);
...
f32 log_wave_height(Object_Log *log, s32 updateRate) {
    ...
    y = (((f32) var_t0 / 16.0f) + (f32) log->unk0);
...
void func_800BF524(Object *obj) {
    ...
    func_800BF634(obj, obj->segment.trans.x_position, obj->segment.trans.z_position, (f32) temp_v0->unkA,
                  temp_v0->unk9 << 8, (f32) temp_v0->unk8 / 16.0f, (f32) temp_v0->unkE, (f32) temp_v0->unkC / 16.0f,
                  var_v1);
}
