...
/* 0D75E8 800D69E8 24040067 */  li    $a1, 103
/* 0D75EC 800D69EC 10830002 */  beq   $a1, $v1, .L800D69F8
...
/* 0D7680 800D6A80 02202825 */  move  $a0, $s1
...
/* 0D7710 800D6B10 0C03385C */  jal   bcopy
/* 0D7714 800D6B14 01F92021 */   addu  $a1, $t7, $t9
...
/* 0D772C 800D6B2C 02202825 */   move  $a0, $s1
/* 0D7730 800D6B30 8E0F0008 */  lw    $t7, 8($s0)
/* 0D7734 800D6B34 8E190014 */  lw    $t9, 0x14($s0)
/* 0D7738 800D6B38 02202825 */  move  $a0, $s1
/* 0D773C 800D6B3C 02603025 */  move  $a2, $s3
/* 0D7740 800D6B40 0C03385C */  jal   bcopy
/* 0D7744 800D6B44 01F92021 */   addu  $a1, $t7, $t9
...
/* 0D77AC 800D6BAC 0C03385C */  jal   bcopy
/* 0D77B0 800D6BB0 01D82021 */   addu  $a1, $t6, $t8
...
/* 0D7810 800D6C10 02512821 */   addu  $a0, $s2, $s1
...
/* 0D782C 800D6C2C 0C03385C */  jal   bcopy
/* 0D7830 800D6C30 03382021 */   addu  $a1, $t9, $t8
...
.L800D6C50:
/* 0D7850 800D6C50 10830003 */  beq   $a1, $v1, .L800D6C60
...
.L800D6C8C:
/* 0D788C 800D6C8C 14830003 */  bne   $a1, $v1, .L800D6C9C
...
/* 0D7918 800D6D18 02202825 */   move  $a0, $s1
...
/* 0D7934 800D6D34 0C03385C */  jal   bcopy
/* 0D7938 800D6D38 03382021 */   addu  $a1, $t9, $t8
