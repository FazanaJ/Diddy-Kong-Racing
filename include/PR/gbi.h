...
#define	gDPTileSync(pkt)	gDPNoParam(pkt, G_RDPLOADSYNC)
#define	gsDPTileSync()		gsDPNoParam(G_RDPLOADSYNC)
#define gDPPipeSync(pkt)	gDPNoParam(pkt, G_RDPTILESYNC)
#define gsDPPipeSync()		gsDPNoParam(    G_RDPTILESYNC)
